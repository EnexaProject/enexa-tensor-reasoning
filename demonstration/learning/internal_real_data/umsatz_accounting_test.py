...
positiveValues1 = sampleDf["tev:Umsatzsteuer_7(usatz)"].values
positiveCore1 = cc.CoordinateCore(positiveValues1,["j"])
positiveValues2 = sampleDf["tev:Umsatzsteuer_19(usatz)"].values
positiveCore2 = cc.CoordinateCore(positiveValues2,["j"])
positiveCore = positiveCore1.compute_or(positiveCore2)
